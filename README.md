...
Terciária,#FF7F50,Botões de Ação (CTA),Cor de destaque para ações principais que não são urgências.
Alerta/SOS,#FF222D,Botão SOS e Atrasos,Alta visibilidade. Exclusiva para ações críticas e emergências.
Fundo,#FFFFFF,Telas e Cards,Mantém o visual limpo e evita fadiga visual.

⚠️ Regras de Ouro para o Front-end
Para garantir a conformidade com as normas de acessibilidade, todo o desenvolvimento deve seguir estas diretrizes:
...
🛠️ Implementação Técnica (Flet)
A lógica de cores está centralizada no arquivo theme.py, garantindo que todo o app respeite a identidade visual e os padrões de acessibilidade:
